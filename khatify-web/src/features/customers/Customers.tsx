                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell className="text-right py-3">
                            <div className={`font-bold ${c.balance > 0 ? 'text-destructive' : c.balance < 0 ? 'text-primary' : 'text-muted-foreground'}`}>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg bg-muted/30 border border-border/40">
                      <div>
                        ...
                        <div className={`text-xl font-bold mt-0.5 ${activeCustomer.balance > 0 ? 'text-destructive' : activeCustomer.balance < 0 ? 'text-primary' : 'text-muted-foreground'}`}>
                          ...
                          <tbody className="divide-y divide-border/40">
                            {customerLedger.map((entry: LedgerEntry) => (
                              <tr key={entry.id} className="hover:bg-muted/20">
                                ...
                                <td className="p-3">
                                  {entry.type === 'debit' ? (
                                    <span className="text-destructive font-semibold">DEBIT (Dr)</span>
                                  ) : (
                                    <span className="text-primary font-semibold">CREDIT (Cr)</span>
                                  )}
                                </td>
        ...
        <DialogContent>
          ...
          <form onSubmit={editForm.handleSubmit(handleUpdateCustomer)} className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              {editForm.formState.errors.phone && <p className="text-xs text-destructive">{editForm.formState.errors.phone.message}</p>}
            </div>
