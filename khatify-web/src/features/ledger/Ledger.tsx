    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 max-w-4xl">
        <Card className="p-4 bg-card/60">
          ...
          <div className="text-lg font-bold text-destructive mt-1">{formatCurrency(totalDebits)}</div>
        ...
        <Card className="p-4 bg-card/60">
          ...
          <div className="text-lg font-bold text-primary mt-1">{formatCurrency(totalCredits)}</div>
        ...
        <Card className="p-4 bg-card/60">
          ...
          <div className={`text-lg font-bold mt-1 ${netReceivables > 0 ? 'text-destructive' : 'text-primary'}`}>
              ...
              <TableBody>
                {filteredLedger.map((entry) => (
                  <TableRow key={entry.id}>
                    ...
                    <TableCell>
                      {entry.type === 'debit' ? (
                        <Badge variant="outline" className="text-destructive border-destructive/20 bg-destructive/5 gap-1 py-0.5 font-semibold">
                          <ArrowUpRight className="h-3 w-3 shrink-0" /> Debit (Dr)
                        </Badge>
                      ) : (
                        <Badge variant="outline" className="text-primary border-primary/20 bg-primary/5 gap-1 py-0.5 font-semibold">
