    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="p-4 bg-card/60">
          ...
          <div className="text-lg font-bold text-primary mt-1">{formatCurrency(collected)}</div>
        </Card>
        <Card className="p-4 bg-card/60">
          <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider block">Outstanding Balance</span>
          <div className="text-lg font-bold text-destructive mt-1">{formatCurrency(outstanding)}</div>
        </Card>
        <Card className="p-4 bg-card/60">
          <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider block">Overdue Amount</span>
          <div className="text-lg font-bold text-destructive mt-1">{formatCurrency(overdueAmount)}</div>
        </Card>
      </div>
